...
This document provides guidelines for internationalization of the Zip Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zip_en.ts` remains unchanged.
