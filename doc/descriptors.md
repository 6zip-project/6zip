# Support for Output Descriptors in Zip Core

Since Zip Core v0.17, there is support for Output Descriptors. This is a
...
existing Zip Core wallets, a convenience function `combo` is
...
All RPCs in Zip Core will include the checksum in their output. Only
