Contributing to Zip Core
============================

The Zip Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Zip Core
...
Before you start contributing, familiarize yourself with the Zip Core build
system and tests. Refer to the documentation in the repository on how to build
Zip Core and how to run the unit and functional tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/6zip-online/zip/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
Most communication about Zip Core development happens on Discord Server.
...
fork of Zip Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/6zip-online/zip/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Zip Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Zip
Network Protocol consensus changes.

Whether a pull request is merged into Zip Core rests with the project merge
...
Patches that change Zip consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zip consensus, it must have been
...
The review process is normally fairly responsive on the Zip Core repository, however
...
Bitcoin Backports are an incredibly valuable part of Zip's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for Zip](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each Zip Core release.
