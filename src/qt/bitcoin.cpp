...
static void SetupUIArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-windowtitle=<name>", _("Sets a window title which is appended to \"Zip Core - \"").translated, ArgsManager::ALLOW_ANY, OptionsCategory::GUI);
}
