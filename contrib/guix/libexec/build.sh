...
(
    ...
    sed -i.old 's/-lstdc++ //g' {./,src/zipbls/,src/secp256k1/}{config.status,libtool}
    ...
    # Setup the directory where our Zip Core build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built Zip Core to $INSTALLPATH
