...
This mechanism has been integrated into Bitcore-Node-Zip which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/6zip-online/insight-api-zip#web-socket-api](https://github.com/6zip-online/insight-api-zip#web-socket-api)
* API: [https://github.com/6zip-online/insight-api-zip#instantsend-transactions](https://github.com/6zip-online/insight-api-zip#instantsend-transactions)
