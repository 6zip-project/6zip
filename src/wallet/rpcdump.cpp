...
UniValue importaddress(const JSONRPCRequest& request)
{
    ...
    "as change, and not show up in many RPCs.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Zip address (or hex-encoded script)"},
...

    {
        ...
        if (IsValidDestination(dest)) {
            ...
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Zip address or script");
        }
    }
    if (fRescan)
    {
...
UniValue dumpprivkey(const JSONRPCRequest& request)
{
    RPCHelpMan{"dumpprivkey",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Zip address for the private key"},
        },
        RPCResult{
...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by Zip Core %s\n", CLIENT_BUILD);
