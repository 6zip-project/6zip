...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 ZIP
        ...
        # feeRate of 0.1 6ZIP / KB produces a total fee slightly below -maxtxfee (~0.06650000):
        ...
        # feeRate of 10 ZIP / KB produces a total fee well above -maxtxfee
