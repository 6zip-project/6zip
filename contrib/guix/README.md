# Bootstrappable Zip Core Builds

This directory contains the files necessary to perform bootstrappable Zip
Core builds.
...
To build Zip Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/zip-detached-sigs> ./contrib/guix/guix-codesign
```
