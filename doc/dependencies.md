...
These are the dependencies currently used by Zip Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| FreeType | [2.11.0](https://download.savannah.gnu.org/releases/freetype) |  | No |  | [Yes](https://github.com/6zip-online/zip/blob/develop/depends/packages/qt.mk) (Android only) |
| GCC |  | [7+](https://gcc.gnu.org/) (C++17 support) |  |  |  |
| glibc | | [2.28](https://www.gnu.org/software/libc/) |  |  |  |  |
| HarfBuzz-NG |  |  |  |  | [Yes](https://github.com/6zip-online/zip/blob/develop/depends/packages/qt.mk) |
...
| libpng |  |  |  |  | [Yes](https://github.com/6zip-online/zip/blob/develop/depends/packages/qt.mk) |
| Linux Kernel | [N/A](https://www.kernel.org/) | 3.2.0 | | | |
| MiniUPnPc | [2.2.2](https://miniupnp.tuxfamily.org/files) |  | No |  |  |
| PCRE |  |  |  |  | [Yes](https://github.com/6zip-online/zip/blob/develop/depends/packages/qt.mk) |
...
| XCB |  |  |  |  | [Yes](https://github.com/6zip-online/zip/blob/develop/depends/packages/qt.mk) (Linux only) |
| xkbcommon |  |  |  |  | [Yes](https://github.com/6zip-online/zip/blob/develop/depends/packages/qt.mk) (Linux only) |
| ZeroMQ | [4.3.1](https://github.com/zeromq/libzmq/releases) | 4.0.0 | No |  |  |
| zlib |  |  |  |  | [Yes](https://github.com/6zip-online/zip/blob/develop/depends/packages/qt.mk) |
