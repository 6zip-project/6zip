...
"""Verify that starting zipd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zipd with -h for help text")
        ...
        self.log.info("Start zipd with -version for version information")
        ...
        self.log.info("Start zipdd with -fakearg to make sure it does not start")
