...
# TestP2PConn: A peer we use to send messages to zipd, and store responses.
...
#            "-txindex",
    ...
    # This test actually causes zipd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that zipd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for zipd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # zipd will not send blocktxn responses for blocks whose height is
