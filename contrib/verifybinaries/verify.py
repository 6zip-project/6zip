...
"""Script for verifying Zip Core release binaries
...
HASHFILE = "hashes.tmp"
HOST1="https://github.com/6zip-online/zip/releases/download/v"
HOST2="https://zipcore-binaries.thepasta.org/file/zipcore-binaries/"
VERSIONPREFIX=""
...
def main(args):
    ...
    if not success:
        print("github.com failed to provide signature file, "
              "but zipcore-binaries.thepasta.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Zip Core binary release "
    ...
    for _, binary_filename in hashes_to_verify:
        ...
        if retval != 0:
            if retval == 1:
                ...
                print("gpg error. Do you have the Zip Core binary release signing key installed?")
            print("gpg output:")
            print(indent(output, '\t'))
